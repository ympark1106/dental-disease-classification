...
def split_and_save_data(image_dir, all_annotations, output_dir):
    ...
    train_data, test_data = train_test_split(all_annotations, test_size=0.2, stratify=[ann[1].get('category_id_3') for ann in all_annotations], random_state=42)
    train_data, val_data = train_test_split(train_data, test_size=0.1, stratify=[ann[1].get('category_id_3') for ann in train_data], random_state=42)
...
if __name__ == "__main__":
    root = "/home/youmin/workspace/VFMs-Adapters-Ensemble/dental_cls"
    json_file_path = os.path.join(root, "quadrant-enumeration-disease/train_quadrant_enumeration_disease.json")
    image_dir = os.path.join(root, "quadrant-enumeration-disease/xrays")  # Local directory containing images
    ...
    test_img = load_image('/home/youmin/workspace/VFMs-Adapters-Ensemble/dental_cls/quadrant-enumeration-disease/xrays/train_199.png')
